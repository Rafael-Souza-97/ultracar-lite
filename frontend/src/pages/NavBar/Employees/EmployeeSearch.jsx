...
function EmployeeSearch() {
  ...
  const filteredMock = mockEmployees.filter((mecanico) =>
    mecanico.name.toLowerCase().includes(nome.toLocaleLowerCase())
  );

  return (
    <div className="overflow-x-auto py-10 mt-1 pt-44 mb-96">
      ...
      <table className="table-auto w-full">
        ...
        <tbody>
          {filteredMock.map((employee, index) => (
